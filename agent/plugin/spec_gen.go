...
func (z *PluginData) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0004 uint32
...
func (z PluginData) EncodeMsg(en *msgp.Writer) (err error) {
...
func (z PluginData) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *PluginData) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0004 uint32
...
func (z PluginData) Msgsize() (s int) {
