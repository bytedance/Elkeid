...
do 
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el7/x86_64/RPMS/kernel-ml-devel"-$each_ml_version.el7.elrepo.x86_64.rpm
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el7/x86_64/RPMS/kernel-ml-tools"-$each_ml_version.el7.elrepo.x86_64.rpm
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el7/x86_64/RPMS/kernel-ml-tools-libs"-$each_ml_version.el7.elrepo.x86_64.rpm
