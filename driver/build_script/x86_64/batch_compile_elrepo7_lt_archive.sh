...
for each_tag in `curl https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/ | grep el7.elrepo.x86_64.rpm | grep kernel-lt-devel | sed -r 's/.*href="([^"]+).*/\1/g' | sed -r 's/kernel-lt-devel-([^"]+).el7.elrepo.x86_64.rpm/\1/g'`
do 
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-lt-devel"-$each_tag.el7.elrepo.x86_64.rpm
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-lt-tools"-$each_tag.el7.elrepo.x86_64.rpm
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-lt-tools-libs"-$each_tag.el7.elrepo.x86_64.rpm
