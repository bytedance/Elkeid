...
for each_ml_version in `curl https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/ | grep el7.elrepo.x86_64.rpm | grep kernel-ml-devel | sed -r 's/.*href="([^"]+).*/\1/g' | sed -r 's/kernel-ml-devel-([^"]+).el7.elrepo.x86_64.rpm/\1/g'`
do 
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-ml-devel"-$each_ml_version.el7.elrepo.x86_64.rpm
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-ml-tools"-$each_ml_version.el7.elrepo.x86_64.rpm
    wget -q "https://mirror.rcg.sfu.ca/mirror/ELRepo/kernel/el7/x86_64/RPMS/kernel-ml-tools-libs"-$each_ml_version.el7.elrepo.x86_64.rpm
