/*
   ...
   modified by Terry|Josin (xeapplee@gmail.com)
   remove const char * to char *, with other code remain it's original face.
*/
...
static int hashmap_put(struct hashmap_s *const hashmap, char *const key,
...
int hashmap_put(struct hashmap_s *const m, char *const key,
