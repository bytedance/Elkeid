...
| execve             | 59       |                                                | ON      |
| create file        | 602      |                                                | ON      |
| ptrace             | 101      | only PTRACE_POKETEXT or PTRACE_POKEDATA ptrace | ON      |
| dns queny          | 601      |                                                | ON      |
...
All hook print data consists of **common data** + **special data**
...
* **socket_exe/dip/dport/sip/sport/sa_family** data from execve fd

* **ssh/ld_preload** data from execve env
...
| CPU       |  Intel(R) Xeon(R) Platinum 8260 CPU @ 2.40GHz    8核 |
| --------- | ------------------------------------------------   |
| RAM       | 16GB                                              |
