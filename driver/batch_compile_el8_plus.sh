...
do 
    ...
    rpm -ivh --force /root/headers/{kernel-plus-devel-$each_lt_version.centos.plus.x86_64.rpm,kernel-plus-devel-$each_lt_version.centos.plus.x86_64.rpm,kernel-plus-devel-$each_lt_version.centos.plus.x86_64.rpm}
