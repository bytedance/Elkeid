...
do 
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el8/x86_64/RPMS/kernel-lt-devel"-$each_lt_version.el8.elrepo.x86_64.rpm
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el8/x86_64/RPMS/kernel-lt-tools"-$each_lt_version.el8.elrepo.x86_64.rpm
    wget "http://mirrors.coreix.net/elrepo-archive-archive/kernel/el8/x86_64/RPMS/kernel-lt-tools-libs"-$each_lt_version.el8.elrepo.x86_64.rpm
