...
cp  target/x86_64-unknown-linux-gnu/release/scanner_plugin  ./output/scanner
...
cp  target/x86_64-unknown-linux-gnu/release/scanner_cli  ./output/scanner_cli
...
tar zcvf scanner.tar.gz scanner tmp
cd - 
